...
# 	rows = []
# 	rows.append(raw_input("Enter the first row of the matrix(3 integers space seperated)."))
# 	rows.append( raw_input("Enter the second row of the matrix(3 integers space seperated)."))
# 	rows.append(raw_input("Enter the third row of the matrix(3 integers space seperated)."))
...
# 	for i in range(3):
# 		print("Row %s : %s" % str(i+1), str(t_matrix[i]))
#
# def sample_text_function1():
# 	print("Hello! I'm Elth. I'm your algorithms bot.")
# 	# first_name = raw_input("Before starting please tell me your first name")
